      ...
      function () {
        (function (a, w) {
            ...
            function c(e, t) {
              ...
              if (e) {
                ...
                if (i === o || typeof i !== "number") {
                  for (n in e)
                    if (e.hasOwnProperty(n)) if (t(e[n], n) === false) return;
          ...
          e("moxie/core/utils/Encode", [], function () {
            ...
            var e = function (e, t) {
              if (typeof window.atob === "function")
                return t ? p(window.atob(e)) : window.atob(e);
              var i =
            ...
            return { utf8_encode: g, utf8_decode: p, atob: e, btoa: t };
          });
          e("moxie/core/utils/Env", ["moxie/core/utils/Basic"], function (r) {
            var e = (function (f) {
              ...
              var v = {
                rgx: function () {
                  for (
                    var e, t = 0, i, n, r, o, a, s, u = arguments;
                    t < u.length;
                    t += 2
                  ) {
                    var l = u[t],
            ...
            var i = (function () {
              var n = {
                ...
                return_response_type: function (e) {
                  try {
                    if (r.inArray(e, ["", "text", "document"]) !== -1)
                      return true;
                ...
                use_data_uri_over32kb: function () {
                  return (
                    n.use_data_uri && (o.browser !== "IE" || o.version >= 9)
                  );
                },
                use_data_uri_of: function (e) {
                  return (
                    (n.use_data_uri && e < 33e3) || n.use_data_uri_over32kb()
                  );
                },
            ...
            o.OS = o.os;
            if (MXI_DEBUG) {
              o.debug = { runtime: true, events: false };
              o.log = function () {
                function e(e) {
                ...
                if (
                  ...
                  if (r.typeOf(i) === "string")
                    i = r.sprintf.apply(this, arguments);
            ...
            return {
              RuntimeError: (function () {
                ...
                function e(e, t) {
                  ...
                  this.name = r(i, e);
                  this.message =
                    this.name + (t || ": RuntimeError " + this.code);
                }
                n.extend(e, i);
              ...
              EventException: (function () {
                ...
                n.extend(e, { UNSPECIFIED_EVENT_TYPE_ERR: 0 });
                e.prototype = Error.prototype;
                return e;
              })(),
            };
            ...
            var o = function (e, t) {
              ...
              function u(e) {
                ...
                if (e) {
                  ...
                  t =
                    o.compatMode === "CSS1Compat" ? o.documentElement : o.body;
            ...
            function (l, c, f) {
              ...
              f.extend(e.prototype, {
                ...
                addEventListener: function (e, t, i, n) {
                  ...
                  o.push({ fn: t, priority: i, scope: n || this });
                ...
                dispatchEvent: function (t) {
                  ...
                  if (f.typeOf(t) !== "string") {
                    ...
                    if (f.typeOf(r.type) === "string") {
                      ...
                      throw new c.EventException(
                        c.EventException.UNSPECIFIED_EVENT_TYPE_ERR,
                      );
                  }
                  if (t.indexOf("::") !== -1)
                    (function (e) {
          ...
          e(
            ...
            function (l, c, f, i) {
              ...
              function m(e, t, r, i, n) {
                ...
                a = (function () {
                  ...
                  return {
                    exec: function (e, t, i, n) {
                      if (a[t]) {
                        if (!r[e])
                          r[e] = { context: this, instance: new a[t]() };
                        if (r[e].instance[i])
                          return r[e].instance[i].apply(this, n);
                      }
                    },
                ...
                if (this.mode && e.required_caps && !this.can(e.required_caps))
                  this.mode = false;
              }
                  ...
                  c.each(e, function (e, t) {
                    if (n.hasOwnProperty(t)) {
                      ...
                      if (!r) r = i;
                        ...
                        if (MXI_DEBUG && l.debug.runtime)
                          l.log(
                            "\t\t%s: %s (conflicting mode requested: %s)",
                            t,
                            e,
                            i,
                          );
              ...
              m.getGlobalEventTarget = function () {
                if (
                  /^moxie\./.test(l.global_event_dispatcher) &&
                  !l.can("access_global_ns")
                ) {
          ...
          e(
            ...
            function (o, i, r) {
              ...
              function s(e, t) {
                ...
                if (!t) t = {};
                else if (o.typeOf(t) === "string") t = { data: t };
                o.extend(this, {
          ...
          e(
            ...
            function (s, n, r, u, o, e, l, c, f) {
              ...
              function t(a) {
                ...
                i = {
                  accept: [
                    { title: l.translate("All Files"), extensions: "*" },
                  ],
                  multiple: false,
                  required_caps: false,
                ...
                if (typeof a.accept === "string")
                  a.accept = r.mimes2extList(a.accept);
                e = u.get(a.container);
                if (!e) e = document.body;
                if (u.getStyle(e, "position") === "static")
                ...
                s.extend(this, {
                  ...
                  init: function () {
                    ...
                    t.connectRuntime(
                      s.extend({}, a, { required_caps: { select_file: true } }),
                    );
                  },
                  ...
                  setOption: function (e, t) {
                    ...
                    switch (e) {
                      ...
                      case "container":
                      case "required_caps":
                        throw new o.FileException(
                          o.FileException.NO_MODIFICATION_ALLOWED_ERR,
                        );
                    }
                    a[e] = t;
          ...
          e(
            ...
            function (t, r, e, o, a, i, s, n, u) {
              ...
              function c(i) {
                ...
                var n = this,
                  e;
                if (typeof i === "string") i = { drop_zone: i };
                e = {
                  accept: [
                    { title: t.translate("All Files"), extensions: "*" },
                  ],
            ...
            function (e, r, o, t, a, i) {
              ...
              function s() {
                ...
                e.extend(this, {
                  ...
                  abort: function () {
                    this.result = null;
                    if (e.inArray(this.readyState, [s.EMPTY, s.DONE]) !== -1)
                      return;
                    else if (this.readyState === s.LOADING)
                ...
                function t(e, t) {
                  ...
                  if (this.readyState === s.LOADING) {
                    this.trigger(
                      "error",
                      new o.DOMException(o.DOMException.INVALID_STATE_ERR),
                    );
                    this.trigger("loadend");
                    return;
                  }
                  if (!(t instanceof a)) {
                    this.trigger(
                      "error",
                      new o.DOMException(o.DOMException.NOT_FOUND_ERR),
                    );
                    this.trigger("loadend");
                    return;
                  }
          ...
          e("moxie/core/utils/Url", ["moxie/core/utils/Basic"], function (f) {
            ...
            return { parseUrl: d, resolveUrl: e, hasSameOrigin: t };
          });
          e(
              ...
              function t() {
                ...
                a.extend(this, {
                  append: function (i, e) {
                    var n = this,
                      t = a.typeOf(e);
                    if (e instanceof s) r = { name: i, value: e };
                    else if ("array" === t) {
                      i += "[]";
                      a.each(e, function (e) {
                        n.append(i, e);
                      ...
                      n.append(i, "false");
                    else o.push({ name: i, value: e.toString() });
                  },
                  hasBlob: function () {
                    return !!this.getBlob();
                  },
              ...
              function k() {
                ...
                T.extend(this, n, {
                  ...
                  open: function (e, t, i, n, r) {
                    ...
                    s = D.resolveUrl(t);
                    if ((n || r) && !x)
                      throw new S.DOMException(
                        S.DOMException.INVALID_ACCESS_ERR,
                      );
                    c = n || o.user;
                    f = r || o.pass;
                    a = i || true;
                  ...
                  setRequestHeader: function (e, t) {
                    ...
                    if (R("readyState") !== k.OPENED || h)
                      throw new S.DOMException(
                        S.DOMException.INVALID_STATE_ERR,
                      );
                    if (/[\u0100-\uffff]/.test(e) || O.utf8_encode(e) !== e)
                      throw new S.DOMException(S.DOMException.SYNTAX_ERR);
                    e = T.trim(e).toLowerCase();
                    if (!!~T.inArray(e, i) || /^(proxy\-|sec\-)/.test(e))
                      return false;
                    if (!l[e]) l[e] = t;
                    else l[e] += ", " + t;
                    return true;
                  ...
                  getResponseHeader: function (e) {
                    e = e.toLowerCase();
                    if (v || !!~T.inArray(e, ["set-cookie", "set-cookie2"]))
                      return null;
                    if (b && b !== "") {
                      if (!_) {
                        _ = {};
                      ...
                      if (_.hasOwnProperty(e))
                        return _[e].header + ": " + _[e].value;
                    }
                    return null;
                  },
                  overrideMimeType: function (e) {
                    var t, i;
                    if (!!~T.inArray(R("readyState"), [k.LOADING, k.DONE]))
                      throw new S.DOMException(
                        S.DOMException.INVALID_STATE_ERR,
                      );
                    e = T.trim(e.toLowerCase());
                  ...
                  send: function (e, t) {
                    if (T.typeOf(t) === "string") y = { ruid: t };
                    else if (!t) y = {};
                    else y = t;
                    if (this.readyState !== k.OPENED || h)
                      throw new S.DOMException(
                        S.DOMException.INVALID_STATE_ERR,
                      );
                    if (e instanceof L) {
                  ...
                  abort: function () {
                    ...
                    m = false;
                    if (
                      !~T.inArray(R("readyState"), [k.UNSENT, k.OPENED, k.DONE])
                    ) {
                      R("readyState", k.DONE);
                      h = false;
                      if (E)
                ...
                function R(e, t) {
                  ...
                  if (arguments.length === 1)
                    return F.can("define_property") ? n[e] : i[e];
                ...
                function I(e) {
                  ...
                  function r(t) {
                    ...
                    E.bind("Load", function (e) {
                      ...
                      R(
                        "status",
                        Number(
                          t.exec.call(E, "XMLHttpRequest", "getStatus") || 0,
                        ),
                      );
                      ...
                      else if (R("responseType") === "document")
                  ...
                  if (!T.isEmptyObj(l))
                    y.required_caps.send_custom_headers = true;
              ...
              function h() {
                ...
                d.extend(this, {
                  ...
                  transport: function (e, i, t) {
                    var n = this;
                    t = d.extend({ chunk_size: 204798 }, t);
                    if ((o = t.chunk_size % 3)) t.chunk_size += 3 - o;
                    u = t.chunk_size;
                    l.call(this);
                    a = e;
                    s = e.length;
                    if (d.typeOf(t) === "string" || t.ruid)
                      c.call(n, i, this.connectRuntime(t));
                    else {
                      var r = function (e, t) {
                ...
                function c(e, t) {
                  ...
                  i.bind(
                    ...
                    function (e) {
                      r = e.loaded;
                      if (r < s && d.inArray(i.state, [h.IDLE, h.DONE]) === -1)
                        f.call(i);
                    },
                    999,
                  );
              ...
              function v() {
                ...
                l.extend(this, {
                  ...
                  resize: function (e) {
                    ...
                    var i;
                    var n;
                    var r = { x: 0, y: 0, width: t.width, height: t.height };
                    var o = l.extendIf(
                      {
                        width: t.width,
                        height: t.height,
                    ...
                    try {
                      if (!t.size)
                        throw new f.DOMException(
                          f.DOMException.INVALID_STATE_ERR,
                        );
                      if (
                        t.width > v.MAX_RESIZE_WIDTH ||
                        t.height > v.MAX_RESIZE_HEIGHT
                      )
                        throw new f.ImageError(f.ImageError.MAX_RESOLUTION_ERR);
                      i =
                        (t.meta && t.meta.tiff && t.meta.tiff.Orientation) || 1;
                  ...
                  embed: function (a, e) {
                    ...
                    function i(e, t) {
                      ...
                      if (m.can("use_data_uri_of", r.length)) {
                        ...
                        o.transport(
                          p.atob(r.substring(r.indexOf("base64,") + 7)),
                          e,
                          {
                    ...
                    try {
                      if (!(a = c.get(a)))
                        throw new f.DOMException(
                          f.DOMException.INVALID_NODE_TYPE_ERR,
                        );
                      if (!this.size)
                        throw new f.DOMException(
                          f.DOMException.INVALID_STATE_ERR,
                      ...
                      if (
                        this.width > v.MAX_RESIZE_WIDTH ||
                        this.height > v.MAX_RESIZE_HEIGHT
                      );
                      var n = new v();
                ...
                var r = o.extend(
                  {
                    ...
                    filter_by_extension: i(
                      (function () {
                        return !(
                          (s.browser === "Chrome" &&
                            s.verComp(s.version, 28, "<")) ||
                          (s.browser === "IE" &&
                            s.verComp(s.version, 10, "<")) ||
                          (s.browser === "Safari" &&
                            s.verComp(s.version, 7, "<")) ||
                          (s.browser === "Firefox" &&
                            s.verComp(s.version, 37, "<"))
                        );
                      })(),
                    ),
                    ...
                    select_folder: function () {
                      return (
                        t.can("select_file") &&
                        ((s.browser === "Chrome" &&
                          s.verComp(s.version, 21, ">=")) ||
                          (s.browser === "Firefox" &&
                            s.verComp(s.version, 42, ">=")))
                      );
                    },
                    ...
                    summon_file_dialog: function () {
                      return (
                        ...
                        !(
                          (s.browser === "Firefox" &&
                            s.verComp(s.version, 4, "<")) ||
                          (s.browser === "Opera" &&
                            s.verComp(s.version, 12, "<")) ||
          ...
          e(
            ...
            function (a) {
                ...
                for (var o = n.length - 1; o >= 0; o--)
                  if (n[o].orig === i || n[o].key === i) {
                    if (t.removeEventListener)
                      t.removeEventListener(e, n[o].func, false);
              ...
              return { addEvent: e, removeEvent: r, removeAllEvents: t };
            },
          );
          e(
                ...
                d.extend(this, {
                  init: function (e) {
                    ...
                    r.innerHTML =
                      ...
                      (l.multiple && n.can("select_multiple")
                        ? "multiple"
                        : "") +
                      (l.directory && n.can("select_folder")
                    ...
                    if (n.can("summon_file_dialog")) {
                      if (m.getStyle(a, "position") === "static")
                    ...
                    (n.can("summon_file_dialog") ? t : a).setAttribute(
                      "tabindex",
                      -1,
                    );
                    t.onchange = function e() {
                      ...
                      if (g.browser !== "IE" && g.browser !== "IEMobile")
                        this.value = "";
                      else {
                    ...
                    i.trigger({ type: "ready", async: true });
                    r = null;
                  },
                  setOption: function (e, t) {
                    ...
                    switch (e) {
                      case "accept":
                        if (t) {
                          var r =
                            t.mimes ||
                            p.extList2mimes(t, i.can("filter_by_extension"));
              ...
              function t() {
                ...
                d.extend(this, {
                  send: function (n, i) {
                    ...
                    if ("" !== n.responseType && "responseType" in s)
                      if (
                        "json" === n.responseType &&
                        !w.can("return_response_type", "json")
                      )
                        s.responseType = "text";
                ...
                function l(e, t) {
                  ...
                  r.onload = function () {
                    t.append(
                      t.getBlobName(),
                      new g(null, { type: n.type, data: r.result }),
                    );
                    o.send.call(i, e, t);
                  };
            ...
            function (e) {
              ...
              e.extend(t.prototype, {
                ...
                read: function (e, t) {
                  ...
                  for (r = 0, i = 0; r < t; r++)
                    i |= this.readByteAt(e + r) << Math.abs(n + r * 8);
                  return i;
                },
                write: function (e, t, i) {
                  ...
                  for (r = 0; r < i; r++)
                    this.writeByteAt(e + r, (t >> Math.abs(n + r * 8)) & 255);
                },
                BYTE: function (e) {
              ...
              function u(e) {
                ...
                v.extend(this, {
                  ...
                  setExif: function (e, t) {
                    if (e !== "PixelXDimension" && e !== "PixelYDimension")
                      return false;
                ...
                function o(e, t) {
                  ...
                  for (r = 0; r < n; r++) {
                    ...
                    if (a === "ASCII") {
                      ...
                      f = i.asArray(a, l, s);
                      c = s == 1 ? f[0] : f;
                      if (p.hasOwnProperty(o) && typeof c != "object")
                        d[o] = p[o][c];
                      else d[o] = c;
                    }
                  }
              ...
              function e(e) {
                ...
                function o(e) {
                  ...
                  while (t <= e.length()) {
                    ...
                    if (i >= 65472 && i <= 65475) {
                      t += 5;
                      return { height: e.SHORT(t), width: e.SHORT((t += 2)) };
                    }
                    n = e.SHORT((t += 2));
                    t += n - 2;
                  }
            ...
            function (u, l, c) {
              function e(e) {
                ...
                function r() {
                  ...
                  if (e.type == "IHDR") {
                    t = e.start;
                    return { width: o.LONG(t), height: o.LONG((t += 4)) };
                  }
                  return null;
                }
                function a() {
                ...
                function s(e) {
                  ...
                  n = e += 4;
                  r = o.LONG(e + t);
                  return { length: t, type: i, start: n, CRC: r };
                }
              }
              return e;
            },
              ...
              function i() {
                ...
                x.extend(this, {
                  loadFromBlob: function (e) {
                    ...
                    if (!t.can("access_binary"))
                      throw new w.RuntimeError(
                        w.RuntimeError.NOT_SUPPORTED_ERR,
                      );
                    s = e;
                    if (e.isDetached()) {
                      a = e.getSource();
                  ...
                  loadFromImage: function (e, t) {
                    ...
                    h.call(
                      this,
                      t ? (a = e.getAsBinaryString()) : e.getAsDataURL(),
                    );
                  },
                  getInfo: function () {
                    var e = this.getRuntime(),
                    ...
                    if (l) {
                      ...
                      if (
                        t.meta &&
                        t.meta.thumb &&
                        !(t.meta.thumb.data instanceof E)
                      )
                ...
                function c() {
                  if (!o && !i)
                    throw new w.ImageError(w.DOMException.INVALID_STATE_ERR);
                  return o || i;
                }
                function f() {
                  var e = c();
          ...
          e(
            ...
            function (a, s, u, l, c) {
              ...
              function r(n) {
                var r = this,
                  o;
                n = a.extend({ swf_url: s.swf_url }, n);
                c.call(
                  this,
                  n,
                  e,
                  {
                    ...
                    return_response_type: function (e) {
                      if (e === "json" && !!window.JSON) return true;
                      return (
                        !a.arrayDiff(e, ["", "text", "document"]) ||
                        r.mode === "browser"
                      );
                    },
                    return_status_code: function (e) {
                      return (
                        r.mode === "browser" || !a.arrayDiff(e, [200, 404])
                      );
                    },
                    ...
                    upload_filesize: function (e) {
                      return (
                        a.parseSizeStr(e) <= 2097152 || r.mode === "client"
                      );
                    },
                  ...
                  },
                  {
                    ...
                    upload_filesize: function (e) {
                      return a.parseSizeStr(e) >= 2097152
                        ? "client"
                        : "browser";
                    },
                  },
                    ...
                    init: function () {
                      ...
                      o = setTimeout(function () {
                        if (r && !r.initialized) {
                          r.trigger(
                            "Error",
                            new l.RuntimeError(l.RuntimeError.NOT_INIT_ERR),
                          );
                          if (MXI_DEBUG && s.debug.runtime)
                            s.log(
              ...
              var n = {
                send: function (e, i) {
                  ...
                  function a(e, t) {
                    ...
                    i.transport(e.getSource(), e.type, { ruid: r.uid });
                  }
                  ...
                  if (i) {
                    ...
                    try {
                      ...
                      if (!!~l.inArray(e, ["", "text"])) return t.readAsText(i);
                        ...
                        return JSON.parse(t.readAsText(i));
                    } finally {
                      i.destroy();
                    }
                  }
              ...
              var i = {
                loadFromBlob: function (e) {
                  ...
                  if (e.isDetached()) {
                    ...
                    r.transport(e.getSource(), e.type, { ruid: i.uid });
                  } else n(e.getSource());
                },
          ...
          e(
            ...
            function (r, o, e, a, s) {
              ...
              function t(t) {
                var n = this,
                  i;
                t = r.extend({ xap_url: o.xap_url }, t);
                s.call(
                  this,
                  t,
                  u,
                  {
                    ...
                    use_http_method: function (e) {
                      return (
                        n.mode === "client" || !r.arrayDiff(e, ["GET", "POST"])
                      );
                    },
                  },
                  {
                      ...
                      i = setTimeout(
                        function () {
                          if (n && !n.initialized) {
                            n.trigger(
                              "Error",
                              new a.RuntimeError(a.RuntimeError.NOT_INIT_ERR),
                            );
                            if (MXI_DEBUG && o.debug.runtime)
                              o.log(
                ...
                o.call(this, e, s, {
                  ...
                  filter_by_extension: i(
                    (function () {
                      return !(
                        ...
                        (a.browser === "Safari" &&
                          a.verComp(a.version, 7, "<")) ||
                        (a.browser === "Firefox" &&
                          a.verComp(a.version, 37, "<"))
                      );
                    })(),
                  ),
                  resize_image: function () {
                  ...
                  summon_file_dialog: function () {
                    return (
                      ...
                      !(
                        (a.browser === "Firefox" &&
                          a.verComp(a.version, 4, "<")) ||
                        (a.browser === "Opera" &&
                          a.verComp(a.version, 12, "<")) ||
                        (a.browser === "IE" && a.verComp(a.version, 10, "<"))
                      )
                    );
                  },
            ...
            function (e, d, m, h, p, g, v) {
              function t() {
                ...
                function f() {
                  ...
                  m.extend(a.style, { fontSize: "999px", opacity: 0 });
                  o.appendChild(a);
                  e.appendChild(o);
                  m.extend(a.style, {
                    position: "absolute",
                ...
                m.extend(this, {
                  init: function (n) {
                    ...
                    (function () {
                      ...
                      if (o.can("summon_file_dialog")) {
                        if (h.getStyle(e, "position") === "static")
                          e.style.position = "relative";
                  ...
                  setOption: function (e, t) {
                    ...
                    if (e == "accept")
                      l =
                        t.mimes ||
                        g.extList2mimes(t, i.can("filter_by_extension"));
                    n = h.get(u);
                ...
                m.extend(this, {
                  send: function (i, e) {
                    ...
                    if (e instanceof w && e.hasBlob()) {
                      ...
                      a = h.get(o + "_form");
                      if (!a)
                        throw new g.DOMException(g.DOMException.NOT_FOUND_ERR);
                    } else {
                      o = m.guid("uid_");
