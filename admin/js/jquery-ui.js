(!(function (o, u) {
  ...
  function s(e, t) {
    ...
    return "area" === s
      ? ((a = (i = e.parentNode).name),
        !(!e.href || !a || "map" !== i.nodeName.toLowerCase()) &&
          !!(a = o("img[usemap=#" + a + "]")[0]) &&
          n(a))
  ...
  ((o.ui = o.ui || {}),
    ...
    o.fn.extend({
      ...
      scrollParent: function () {
        var e = (
          (o.ui.ie && /(static|relative)/.test(this.css("position"))) ||
          /absolute/.test(this.css("position"))
            ? this.parents().filter(function () {
                return (
                  /(relative|absolute|fixed)/.test(o.css(this, "position")) &&
                  /(auto|scroll)/.test(
                    o.css(this, "overflow") +
                      o.css(this, "overflow-y") +
                      o.css(this, "overflow-x"),
                  )
                );
              })
            : this.parents().filter(function () {
      ...
      zIndex: function (e) {
        ...
        if (this.length)
          for (var t, i, a = o(this[0]); a.length && a[0] !== document; ) {
            if (
              ("absolute" === (t = a.css("position")) ||
                "relative" === t ||
                "fixed" === t) &&
    ...
    o("<a>").outerWidth(1).jquery ||
      o.each(["Width", "Height"], function (e, i) {
        ...
        function r(e, t, i, a) {
          return (
            o.each(s, function () {
              ((t -= parseFloat(o.css(e, "padding" + this)) || 0),
                i &&
                  (t -= parseFloat(o.css(e, "border" + this + "Width")) || 0),
                a && (t -= parseFloat(o.css(e, "margin" + this)) || 0));
            }),
            t
          );
        }
    ...
    (o.support.selectstart = "onselectstart" in document.createElement("div")),
    o.fn.extend({
      disableSelection: function () {
        return this.bind(
          (o.support.selectstart ? "selectstart" : "mousedown") +
            ".ui-disableSelection",
          function (e) {
            e.preventDefault();
          },
      ...
      plugin: {
        add: function (e, t, i) {
          var a,
            s = o.ui[e].prototype;
          for (a in i)
            ((s.plugins[a] = s.plugins[a] || []), s.plugins[a].push([t, i[a]]));
        },
        call: function (e, t, i) {
          var a,
            s = e.plugins[t];
    ...
    ((l.cleanData = function (e) {
      ...
      (l.widget = function (e, i, t) {
        ...
        ((e = e.split(".")[1]),
          (a = u + "-" + e),
          t || ((t = i), (i = l.Widget)),
          (l.expr[":"][a.toLowerCase()] = function (e) {
            return !!l.data(e, a);
          }),
          (l[u] = l[u] || {}),
          (s = l[u][e]),
          ...
          (n.prototype = l.widget.extend(
            ...
            o,
            { constructor: n, namespace: u, widgetName: e, widgetFullName: a },
          )),
          s
      ...
      (l.widget.extend = function (e) {
        for (
          var t, i, a = u.call(arguments, 1), s = 0, n = a.length;
          s < n;
          s++
        )
          for (t in a[s])
            ((i = a[s][t]),
              a[s].hasOwnProperty(t) &&
                i !== o &&
                (l.isPlainObject(i)
      ...
      (l.widget.bridge = function (n, t) {
        ...
        l.fn[n] = function (i) {
          ...
          return (
            (i =
              !e && a.length ? l.widget.extend.apply(null, [i].concat(a)) : i),
            e
              ? this.each(function () {
                  var e,
                    t = l.data(this, r);
                  return t
                    ? l.isFunction(t[i]) && "_" !== i.charAt(0)
                      ? (e = t[i].apply(t, a)) !== t && e !== o
      ...
      (l.Widget.prototype = {
        ...
        option: function (e, t) {
          ...
          if ("string" == typeof e)
            if (((n = {}), (e = (i = e.split(".")).shift()), i.length)) {
              for (
                a = n[e] = l.widget.extend({}, this.options[e]), s = 0;
                s < i.length - 1;
                s++
              )
                ((a[i[s]] = a[i[s]] || {}), (a = a[i[s]]));
              ...
              if (t === o)
                return this.options[e] === o ? null : this.options[e];
              n[e] = t;
            }
        ...
        _on: function (s, n, e) {
          var r,
            o = this;
          ("boolean" != typeof s && ((e = n), (n = s), (s = !1)),
            e
              ? ((n = r = l(n)), (this.bindings = this.bindings.add(n)))
              : ((e = n), (n = this.element), (r = this.widget())),
      ...
      l.each({ show: "fadeIn", hide: "fadeOut" }, function (n, r) {
        l.Widget.prototype["_" + n] = function (t, e, i) {
          var a = (e = "string" == typeof e ? { effect: e } : e)
              ? (!0 !== e && "number" != typeof e && e.effect) || r
              : n,
            s = !l.isEmptyObject(
          ...
          ((e.complete = i),
            ...
            s && l.effects && l.effects.effect[a]
              ? t[n](e)
              : a !== n && t[a]
        ...
        _mouseInit: function () {
          ...
          (this.element
            ...
            .bind("click." + this.widgetName, function (e) {
              if (!0 === s.data(e.target, t.widgetName + ".preventClickEvent"))
                return (
                  s.removeData(e.target, t.widgetName + ".preventClickEvent"),
          ...
          if (!n) {
            ...
            var t = this,
              ...
              a =
                ...
                ) && s(e.target).closest(this.options.cancel).length;
            return i && !a && this._mouseCapture(e)
          ...
          return (
            ...
            this._mouseStarted &&
              ...
              e.target === this._mouseDownEvent.target &&
                s.data(e.target, this.widgetName + ".preventClickEvent", !0),
              this._mouseStop(e)),
            !1
          );
        },
  ...
  (function (b, u) {
    b.extend(b.ui, { datepicker: { version: "1.10.3" } });
    var s,
      o = "datepicker";
    function e() {
      ((this._curInst = null),
    ...
    (b.extend(e.prototype, {
      ...
      _attachDatepicker: function (e, t) {
        ...
        (e.id || ((this.uuid += 1), (e.id = "dp" + this.uuid)),
          ((i = this._newInst(b(e), s)).settings = b.extend({}, t || {})),
          "input" === a
            ? this._connectDatepicker(e, i)
            : s && this._inlineDatepicker(e, i));
      },
            ...
            (t.trigger = b(
              this._get(t, "buttonImageOnly")
                ...
                : b("<button type='button'></button>")
                    .addClass(this._triggerClass)
                    .html(
                      i ? b("<img/>").attr({ src: i, alt: a, title: a }) : a,
                    ),
            )),
      ...
      _dialogDatepicker: function (e, t, i, a, s) {
        ...
        return (
          r ||
            ...
            b.data(this._dialogInput[0], o, r)),
          l(r.settings, a || {}),
        ...
        if (2 === arguments.length && "string" == typeof t)
          return "defaults" === t
            ...
            : o
              ...
              : null;
        ((a = t || {}),
          "string" == typeof t && ((a = {})[t] = i),
          o &&
            (this._curInst === o && this._hideDatepicker(),
            (s = this._getDateDatepicker(e, !0)),
            (n = this._getMinMaxDate(o, "min")),
      ...
      _doKeyDown: function (e) {
        ...
        if (((a._keyEvent = !0), b.datepicker._datepickerShowing))
          switch (e.keyCode) {
            case 9:
            ...
            case 13:
              return (
                ...
                (t = b.datepicker._get(a, "onSelect"))
                  ? ((i = b.datepicker._formatDate(a)),
                    t.apply(a.input ? a.input[0] : null, [i, a]))
                  : b.datepicker._hideDatepicker(),
                !1
              );
            case 27:
            ...
            case 33:
              b.datepicker._adjustDate(
                e.target,
                e.ctrlKey
                  ? -b.datepicker._get(a, "stepBigMonths")
                  : -b.datepicker._get(a, "stepMonths"),
                "M",
              );
              break;
            case 34:
        ...
        ("input" !== (e = e.target || e).nodeName.toLowerCase() &&
          ...
          b.datepicker._isDisabledDatepicker(e) ||
            ...
            !1 !==
              ...
              (a = { left: b.datepicker._pos[0], top: b.datepicker._pos[1] }),
              ...
              b.datepicker._updateDatepicker(s),
              (a = b.datepicker._checkOffset(s, a, t)),
              s.dpDiv.css({
                position:
              ...
              s.inline ||
                ((i = b.datepicker._get(s, "showAnim")),
                (a = b.datepicker._get(s, "duration")),
                s.dpDiv.zIndex(b(e).zIndex() + 1),
                (b.datepicker._datepickerShowing = !0),
                b.effects && b.effects.effect[i]
                  ? s.dpDiv.show(i, b.datepicker._get(s, "showOptions"), a)
                  : s.dpDiv[i || "show"](i ? a : null),
                b.datepicker._shouldFocusInput(s) && s.input.focus(),
                (b.datepicker._curInst = s)))));
      },
      _updateDatepicker: function (e) {
        ((this.maxRows = 4),
          (s = e).dpDiv.empty().append(this._generateHTML(e)),
      ...
      _checkOffset: function (e, t, i) {
        var a = e.dpDiv.outerWidth(),
          ...
          o =
            ...
            (i ? 0 : b(document).scrollLeft()),
          u =
            document.documentElement.clientHeight +
            (i ? 0 : b(document).scrollTop());
        return (
          (t.left -= this._get(e, "isRTL") ? a - n : 0),
          (t.left -=
            i && t.left === e.input.offset().left
              ? b(document).scrollLeft()
              : 0),
          (t.top -=
            i && t.top === e.input.offset().top + r
              ? b(document).scrollTop()
              : 0),
          (t.left -= Math.min(
            t.left,
            t.left + a > o && a < o ? Math.abs(t.left + a - o) : 0,
          )),
          (t.top -= Math.min(
            t.top,
            t.top + s > u && s < u ? Math.abs(s + r) : 0,
          )),
          t
        );
      },
        ...
        !a ||
          ...
          (this._datepickerShowing &&
            ...
            b.effects && (b.effects.effect[t] || b.effects[t])
              ? a.dpDiv.hide(t, b.datepicker._get(a, "showOptions"), i, e)
              : a.dpDiv[
                  "slideDown" === t
                    ? "slideUp"
                    : "fadeIn" === t
            ...
            t || e(),
            (this._datepickerShowing = !1),
            (e = this._get(a, "onClose")) &&
              e.apply(a.input ? a.input[0] : null, [
                a.input ? a.input.val() : "",
                a,
              ]),
      ...
      _adjustDate: function (e, t, i) {
        ...
        this._isDisabledDatepicker(a[0]) ||
          (this._adjustInstDate(
            e,
            t + ("M" === i ? this._get(e, "showCurrentAtPos") : 0),
            i,
          ),
          this._updateDatepicker(e));
      },
      ...
      _selectDay: function (e, t, i, a) {
        var s = b(e);
        b(a).hasClass(this._unselectableClass) ||
      ...
      _updateAlternate: function (e) {
        ...
        s &&
          ...
          (i = this._getDate(e)),
          (a = this.formatDate(t, i, this._getFormatConfig(e))),
          b(s).each(function () {
            b(this).val(a);
          }));
      },
      ...
      parseDate: function (t, s, e) {
        ...
        function a(e, t, i) {
          ...
          if (
            (b.each(t, function (e, t) {
              var i = t[1];
              if (s.substr(l, i.length).toLowerCase() === i.toLowerCase())
                return ((a = t[0]), (l += i.length), !1);
            }),
            -1 !== a)
          )
            return a + 1;
        ...
        if (
          ...
          for (m = 1, _ = v; ; ) {
            if (_ <= (r = this._getDaysInMonth(g, m - 1))) break;
            (m++, (_ -= r));
          }
        if (
      ...
      _possibleChars: function (t) {
        ...
        for (var i = "", a = !1, s = 0; s < t.length; s++)
          if (a) "'" !== t.charAt(s) || e("'") ? (i += t.charAt(s)) : (a = !1);
          else
            switch (t.charAt(s)) {
              case "d":
              case "m":
                      ...
                      switch (r[2] || "d") {
                        ...
                        case "M":
                          ((a += parseInt(r[1], 10)),
                            (s = Math.min(
                              s,
                              b.datepicker._getDaysInMonth(i, a),
                            )));
                          break;
                        case "y":
                        case "Y":
        ...
        if ((z < 0 && ((z += 12), B--), V))
          for (
            t = this._daylightSavingAdjust(
              new Date(
                V.getFullYear(),
                V.getMonth() - K[0] * K[1] + 1,
                V.getDate(),
              ),
            ),
              t = U && t < U ? U : t;
            this._daylightSavingAdjust(new Date(B, z, 1)) > t;
          )
            --z < 0 && ((z = 11), B--);
        for (
          e.drawMonth = z,
            e.drawYear = B,
            R = this._get(e, "prevText"),
            R = W
              ? this.formatDate(
                  R,
                  this._daylightSavingAdjust(new Date(B, z - O, 1)),
                  this._getFormatConfig(e),
                )
              : R,
            i = this._canAdjustMonth(e, -1, B, z)
            ...
            R = W
              ...
              : R,
            a = this._canAdjustMonth(e, 1, B, z)
              ...
              : P
                ...
                : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" +
                  ...
                  R +
                  "</span></a>",
            P = this._get(e, "currentText"),
            R = this._get(e, "gotoCurrent") && e.currentDay ? H : Y,
            P = W ? this.formatDate(P, R, this._getFormatConfig(e)) : P,
            W = e.inline
              ? ""
            ...
            o = this._get(e, "dayNamesMin"),
            u = this._get(e, "monthNames"),
            l = this._get(e, "monthNamesShort"),
          ...
          for (_ = "", this.maxRows = 4, v = 0; v < K[1]; v++) {
            if (
              ((y = this._daylightSavingAdjust(new Date(B, z, e.selectedDay))),
              (k = " ui-corner-all"),
              (D = ""),
              L)
            ) {
              if (((D += "<div class='ui-datepicker-group"), 1 < K[1]))
                switch (v) {
                  case 0:
                    ((D += " ui-datepicker-group-first"),
                      (k = " ui-corner-" + (E ? "right" : "left")));
                    break;
                  case K[1] - 1:
                    ((D += " ui-datepicker-group-last"),
                      (k = " ui-corner-" + (E ? "left" : "right")));
                    break;
                  default:
            ...
            for (
              D +=
                ...
                k +
                "'>" +
                (/all|left/.test(k) && 0 === m ? (E ? a : i) : "") +
                (/all|right/.test(k) && 0 === m ? (E ? i : a) : "") +
            ...
            for (
              D += b + "</tr></thead><tbody>",
                C = this._getDaysInMonth(B, z),
                B === e.selectedYear &&
                  z === e.selectedMonth &&
                  (e.selectedDay = Math.min(e.selectedDay, C)),
                M = (this._getFirstDayOfMonth(B, z) - s + 7) % 7,
                C = Math.ceil((M + C) / 7),
                x = L && this.maxRows > C ? this.maxRows : C,
                this.maxRows = x,
                I = this._daylightSavingAdjust(new Date(B, z, 1 - M)),
                N = 0;
              N < x;
              N++
            ) {
              for (
                ...
                ((A = h ? h.apply(e.input ? e.input[0] : null, [I]) : [!0, ""]),
                  (T =
                    ((F = I.getMonth() !== z) && !d) ||
                    !A[0] ||
                    (U && I < U) ||
                  ...
                  (S +=
                    "<td class='" +
                    (5 <= (g + s + 6) % 7 ? " ui-datepicker-week-end" : "") +
      ...
      _adjustInstDate: function (e, t, i) {
        var a = e.drawYear + ("Y" === i ? t : 0),
          ...
          t = this._restrictMinMax(
            e,
            this._daylightSavingAdjust(new Date(a, s, t)),
          );
  ...
  (function (h) {
    h.widget("ui.slider", h.ui.mouse, {
      ...
      _createHandles: function () {
        ...
        for (
          i.length > s && (i.slice(s).remove(), (i = i.slice(0, s))),
            e = i.length;
          e < s;
          e++
        )
        ...
        ((this.handles = i.add(h(a.join("")).appendTo(this.element))),
          ...
          ? (!0 === e.range &&
              (e.values
                ? e.values.length && 2 !== e.values.length
                  ...
                  : h.isArray(e.values) && (e.values = e.values.slice(0))
                : (e.values = [this._valueMin(), this._valueMin()])),
            this.range && this.range.length
              ? this.range
                  .removeClass("ui-slider-range-min ui-slider-range-max")
                  .css({ left: "", bottom: "" })
              : ((this.range = h("<div></div>").appendTo(this.element)),
      ...
      _mouseCapture: function (e) {
        ...
        return (
          ...
          !1 !== this._start(e, n) &&
            ...
            (t = s.offset()),
            (r = !h(e.target).parents().addBack().is(".ui-slider-handle")),
            (this._clickOffset = r
              ? { left: 0, top: 0 }
              : {
      ...
      _change: function (e, t) {
        ...
        this._keySliding ||
          this._mouseSliding ||
          ((i = { handle: this.handles[t], value: this.value() }),
          this.options.values &&
            this.options.values.length &&
            ((i.value = this.values(t)), (i.values = this.values())),
      ...
      values: function (e, t) {
        ...
        if (!h.isArray(e))
          return this.options.values && this.options.values.length
            ? this._values(e)
            : this.value();
        for (i = this.options.values, a = e, s = 0; s < i.length; s += 1)
          ((i[s] = this._trimAlignValue(a[s])), this._change(null, s));
        this._refreshValue();
      },
      _setOption: function (e, t) {
        var i,
          ...
          ("range" === e &&
            ...
            ("min" === t
              ...
              : "max" === t &&
                ...
                (this.options.values = null))),
          h.isArray(this.options.values) && (a = this.options.values.length),
      ...
      _values: function (e) {
        ...
        if (this.options.values && this.options.values.length) {
          for (i = this.options.values.slice(), a = 0; a < i.length; a += 1)
      ...
      _refreshValue: function () {
        ...
        this.options.values && this.options.values.length
          ? this.handles.each(function (e) {
              ((i =
                ((o.values(e) - o._valueMin()) /
                  (o._valueMax() - o._valueMin())) *
                100),
                (l["horizontal" === o.orientation ? "left" : "bottom"] =
                  i + "%"),
                h(this).stop(1, 1)[u ? "animate" : "css"](l, r.animate),
                !0 === o.options.range &&
                  ("horizontal" === o.orientation
                    ? (0 === e &&
                        o.range
                          .stop(1, 1)
                          [u ? "animate" : "css"]({ left: i + "%" }, r.animate),
                      1 === e &&
                        o.range[u ? "animate" : "css"](
                          { width: i - t + "%" },
          ...
          : ((e = this.value()),
            ...
            (l["horizontal" === this.orientation ? "left" : "bottom"] =
              i + "%"),
            this.handle.stop(1, 1)[u ? "animate" : "css"](l, r.animate),
            "min" === n &&
              "horizontal" === this.orientation &&
              this.range
                .stop(1, 1)
                [u ? "animate" : "css"]({ width: i + "%" }, r.animate),
            "max" === n &&
              "horizontal" === this.orientation &&
            ...
            "min" === n &&
              ...
              this.range
                .stop(1, 1)
                [u ? "animate" : "css"]({ height: i + "%" }, r.animate),
            "max" === n &&
              "vertical" === this.orientation &&
              this.range[u ? "animate" : "css"](
                { height: 100 - i + "%" },
      ...
      _handleEvents: {
        keydown: function (e) {
          var t,
            i,
            a,
            s = h(e.target).data("ui-slider-handle-index");
          switch (e.keyCode) {
            ...
            case h.ui.keyCode.LEFT:
              if (
                ...
                !this._keySliding &&
                  ((this._keySliding = !0),
                  h(e.target).addClass("ui-state-active"),
                  !1 === this._start(e, s)))
              )
                return;
          }
          switch (
            ...
            case h.ui.keyCode.PAGE_UP:
              i = this._trimAlignValue(
                t + (this._valueMax() - this._valueMin()) / 5,
              );
              break;
            case h.ui.keyCode.PAGE_DOWN:
              i = this._trimAlignValue(
        ...
        keyup: function (e) {
          ...
          this._keySliding &&
            ...
            this._stop(e, t),
            this._change(e, t),
            h(e.target).removeClass("ui-state-active"));
        },
      },
    });
  })(jQuery),
  (function (o) {
      ...
      return (
        ...
        m(e, function (e, t) {
          ...
          if (i)
            return (
              (i = s[t](i)),
              (s[f[t].cache] = i[f[t].cache]),
              (n = s._rgba = i._rgba),
              !1
            );
        }),
        n.length
          ? ("0,0,0,0" === n.join() && h.extend(n, u.transparent), s)
          : u[a]
      );
    }
    function M(e, t, i) {
    ...
    function C(e) {
      ...
      if (a && a.length && a[0] && a[a[0]])
        for (i = a.length; i--; )
          "string" == typeof a[(t = a[i])] && (s[o.camelCase(t)] = a[t]);
      else for (t in a) "string" == typeof a[t] && (s[t] = a[t]);
      return s;
    }
    function x(e, t, i, a) {
      return (
        (e = { effect: (e = o.isPlainObject(e) ? (t = e).effect : e) }),
        o.isFunction((t = null == t ? {} : t)) &&
          ((a = t), (i = null), (t = {})),
        ("number" != typeof t && !o.fx.speeds[t]) ||
          ((a = i), (i = t), (t = {})),
        o.isFunction(i) && ((a = i), (i = null)),
        t && o.extend(e, t),
        (i = i || t.duration),
        (e.duration = o.fx.off
          ? 0
    ...
    function I(e) {
      return (
        ...
        "number" == typeof e ||
        o.fx.speeds[e] ||
        ("string" == typeof e && !o.effects.effect[e]) ||
        o.isFunction(e) ||
    ...
    ((o.effects = { effect: {} }),
      ...
      (r.rgba = -1 < t.style.backgroundColor.indexOf("rgba")),
      m(f, function (e, t) {
        ((t.cache = "_" + e),
      ...
      ((p.fn = h.extend(p.prototype, {
        parse: function (s, e, t, i) {
          ...
          var n = this,
            ...
            r = (this._rgba = []);
          return (
            e !== c && ((s = [s, e, t, i]), (a = "array")),
            "string" === a
              ? this.parse(w(s) || u._default)
              : "array" === a
                ? (m(f.rgba.props, function (e, t) {
                    r[t.idx] = b(s[t.idx], t);
                  }),
                  this)
                : "object" === a
                      ...
                      s instanceof p
                        ...
                        : function (e, i) {
                            ...
                            (m(i.props, function (e, t) {
                              ...
                              n[a] &&
                                h.inArray(null, n[a].slice(0, 3)) < 0 &&
                                ((n[a][3] = 1),
                                i.from && (n._rgba = i.from(n[a]))));
                          },
                    ),
                    this)
                  : void 0
      ...
      (f.hsla.from = function (e) {
        ...
        var t = e[0] / 360,
          ...
          a = 2 * a - i;
        return [
          Math.round(255 * M(a, i, t + 1 / 3)),
          Math.round(255 * M(a, i, t)),
          Math.round(255 * M(a, i, t - 1 / 3)),
          e,
        ];
      }),
      m(f, function (u, e) {
        var n = e.props,
          ...
          l = e.from;
        ((p.fn[u] = function (e) {
          if ((o && !this[r] && (this[r] = o(this._rgba)), e === c))
            return this[r].slice();
          var t,
            i = h.type(e),
            ...
            p.fn[r] ||
              (p.fn[r] = function (e) {
                ...
                return "undefined" === i
                  ? n
                  : ("function" === i &&
                      ((e = e.call(this, n)), (i = h.type(e))),
                    null == e && o.empty
                      ? this
                      : ("string" === i &&
                          (t = d.exec(e)) &&
                          (e = n + parseFloat(t[2]) * ("+" === t[1] ? 1 : -1)),
                        (s[o.idx] = e),
                        this[a](s)));
              });
          }));
        ...
        m(e, function (e, n) {
          ((h.cssHooks[n] = {
            set: function (e, t) {
              ...
              if (
                "transparent" !== t &&
                ("string" !== h.type(t) || (i = w(t)))
              ) {
                if (((t = p(i || t)), !r.rgba && 1 !== t._rgba[3])) {
                  for (
                    a = "backgroundColor" === n ? e.parentNode : e;
            ...
            (h.fx.step[n] = function (e) {
              (e.colorInit ||
                ...
                (e.end = p(e.end)),
                (e.colorInit = !0)),
                h.cssHooks[n].set(e.elem, e.start.transition(e.end, e.pos)));
            }));
        });
      })(
        ...
        function (e, t) {
          o.fx.step[t] = function (e) {
            (("none" !== e.end && !e.setAttr) || (1 === e.pos && !e.setAttr)) &&
              (jQuery.style(e.elem, t, e.end), (e.setAttr = !0));
          };
        },
      ),
      o.fn.addBack ||
                ...
                (this.diff = (function (e, t) {
                  ...
                  for (i in t)
                    ((a = t[i]),
                      e[i] !== a &&
                        (v[i] ||
                          (!o.fx.step[i] && isNaN(parseFloat(a))) ||
                          (s[i] = a)));
                  return s;
                })(this.start, this.end)),
                this
      ...
      o.fn.extend({
        addClass:
          ...
          function (e, t, i, a) {
            return t
              ? o.effects.animateClass.call(this, { add: e }, t, i, a)
        ...
        removeClass:
          ...
          function (e, t, i, a) {
            return 1 < arguments.length
              ? o.effects.animateClass.call(this, { remove: e }, t, i, a)
        ...
        toggleClass:
          ...
          function (e, t, i, a, s) {
            return "boolean" == typeof t || void 0 === t
              ...
              : o.effects.animateClass.call(this, { toggle: e }, t, i, a);
          }),
        switchClass: function (e, t, i, a, s) {
          return o.effects.animateClass.call(
            this,
            { add: t, remove: e },
            i,
            a,
      ...
      o.extend(o.effects, {
        ...
        restore: function (e, t) {
          for (var i, a = 0; a < t.length; a++)
            null !== t[a] &&
              (void 0 === (i = e.data(D + t[a])) && (i = ""), e.css(t[a], i));
        },
        ...
        createWrapper: function (i) {
          ...
          return (
            i.wrap(e),
            (i[0] !== s && !o.contains(i[0], s)) || o(s).focus(),
            (e = i.parent()),
            "static" === i.css("position")
              ...
              : (o.extend(a, {
                ...
                o.each(["top", "left", "bottom", "right"], function (e, t) {
                  ((a[t] = i.css(t)),
                    isNaN(parseInt(a[t], 10)) && (a[t] = "auto"));
                }),
                i.css({
                  position: "relative",
                  top: 0,
        ...
        removeWrapper: function (e) {
          ...
          return (
            e.parent().is(".ui-effects-wrapper") &&
              ...
              (e[0] !== t && !o.contains(e[0], t)) || o(t).focus()),
            e
          );
        },
      ...
      (k = {}),
      o.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (t, e) {
        k[e] = function (e) {
