!(function (e) {
        ...
        (function (e, w, T) {
          ...
          function P(e) {
            ...
            if (typeof t === "string")
              ...
              if (!U.isEmptyObj(e.resize) || e.multipart === false)
                s.send_binary_string = true;
          ...
          var U = {
            ...
            formatSize: function (e) {
              ...
              if (e > 1024)
                return Math.round(e / 1024) + " " + U.translate("kb");
          ...
          U.Uploader = function (e) {
            ...
            function d() {
              ...
              for (e = 0; e < u.length; e++) {
                ...
                if (t.status == U.DONE) n.uploaded++;
                else if (t.status == U.FAILED) n.failed++;
                else n.queued++;
              }
              if (n.size === T)
                n.percent =
                  u.length > 0 ? Math.ceil((n.uploaded / u.length) * 100) : 0;
              else {
                n.bytesPerSec = Math.ceil(r / ((+new Date() - s || 1) / 1e3));
                n.percent =
                  n.size > 0 ? Math.ceil((n.loaded / n.size) * 100) : 0;
              }
            }
            function c() {
              var e = o[0] || l[0];
            ...
            function g(r, e) {
              ...
              if (r.browse_button)
                U.each(r.browse_button, function (i) {
                  t.push(function (t) {
                    var e = new w.file.FileInput(
                      U.extend({}, a, {
                    ...
                    e.bind(
                      ...
                      function (e) {
                        if (!f) {
                          if (r.browse_button_hover)
                            if ("mouseenter" === e.type)
                              U.addClass(i, r.browse_button_hover);
                            else if ("mouseleave" === e.type)
                              U.removeClass(i, r.browse_button_hover);
                          if (r.browse_button_active)
                            if ("mousedown" === e.type)
                              U.addClass(i, r.browse_button_active);
                            else if ("mouseup" === e.type)
                              U.removeClass(i, r.browse_button_active);
                        }
                      },
                    );
              ...
              if (r.drop_element)
                U.each(r.drop_element, function (i) {
                  t.push(function (t) {
                    var e = new w.file.FileDrop(
                      U.extend({}, a, { drop_zone: i }),
                    );
                    e.onready = function () {
                      var e = F.getInfo(this.ruid);
                      U.extend(s.features, {
              ...
              try {
                s.onload = function () {
                  if (
                    ...
                    s.downsize(i.width, i.height, i.crop, i.preserve_headers);
                };
                s.onresize = function () {
            ...
            function v(e, t, i) {
              ...
              function r(e, t, i) {
                ...
                switch (e) {
                  ...
                  case "unique_names":
                    ...
                    break;
                  case "filters":
                    if (U.typeOf(t) === "array") t = { mime_types: t };
                    if (i) U.extend(a.filters, t);
                    else a.filters = t;
                    if (t.mime_types) {
                      if (U.typeOf(t.mime_types) === "string")
                        t.mime_types = w.core.utils.Mime.mimes2extList(
                          t.mime_types,
                        );
                  ...
                  case "resize":
                    if (t)
                      a.resize = U.extend(
                        { preserve_headers: true, crop: false },
                        t,
                      );
                    else a.resize = false;
                    break;
              ...
              if (i) {
                ...
                h = P(U.extend({}, a, { required_features: true }));
              } else if (n) {
                s.trigger("Destroy");
                g.call(s, a, function (e) {
                  if (e) {
                    s.runtime = F.getInfo(c()).type;
                    s.trigger("Init", { runtime: s.runtime });
                    s.trigger("PostInit");
                  } else
                    s.trigger("Error", {
                      code: U.INIT_ERROR,
            ...
            function b(s, n) {
              ...
              function g(e, t, i) {
                ...
                if (m.upload)
                  m.upload.onprogress = function (e) {
                ...
                m.onload = function () {
                  ...
                  if (i < f.size) {
                    ...
                    if (U.ua.browser === "Android Browser")
                      s.trigger("UploadProgress", n);
                ...
                if (s.settings.multipart && l.multipart) {
                  ...
                  U.each(
                    U.extend(e, s.settings.multipart_params),
                    function (e, t) {
                      r.append(t, e);
                    },
                  );
                  ...
                  if (!m.hasRequestHeader("Content-Type"))
                    m.setRequestHeader(
                      "Content-Type",
              ...
              f = n.getSource();
              if (
                !U.isEmptyObj(s.settings.resize) &&
                U.inArray(f.type, ["image/jpeg", "image/png"]) !== -1
              )
                _(f, s.settings.resize, d, function (e) {
                  f = e;
                  n.size = e.size;
                  p();
                });
            ...
            function R(e) {
              if (e.state == U.STARTED) s = +new Date();
                ...
                for (var t = e.files.length - 1; t >= 0; t--)
                  if (e.files[t].status == U.UPLOADING) {
            ...
            function S(e, t) {
              if (t.code === U.INIT_ERROR) e.destroy();
              else if (t.code === U.HTTP_ERROR) {
            ...
            U.extend(this, {
              ...
              init: function () {
                  ...
                  function (e) {
                    if (i.getOption(e) === null) {
                      r = {
                        code: U.INIT_ERROR,
                        message: U.sprintf(
                          U.translate("%s specified, but cannot be found."),
                          e,
                        ),
                      };
                      return false;
                ...
                if (!a.browse_button && !a.drop_element)
              ...
              addFile: function (e, t) {
                ...
                function l(i) {
                  ...
                  } else if (U.inArray(e, ["file", "blob"]) !== -1)
                    l(new w.file.File(null, i));
                  else if (e === "node" && U.typeOf(i.files) === "filelist")
                    U.each(i.files, l);
                  else if (e === "array") {
                    t = null;
                    U.each(i, l);
              ...
              removeFile: function (e) {
                ...
                for (var i = u.length - 1; i >= 0; i--)
                  if (u[i].id === t) return this.splice(i, 1)[0];
              },
              splice: function (e, t) {
              ...
              dispatchEvent: function (e) {
                ...
                if (t) {
                  ...
                  for (var s = 0; s < t.length; s++)
                    if (t[s].fn.apply(t[s].scope, i) === false) return false;
                }
                return true;
              },
            ...
            function e(e) {
              U.extend(this, {
                ...
                getNative: function () {
                  ...
                  return U.inArray(U.typeOf(e), ["blob", "file"]) !== -1
                    ? e
                    : null;
                },
                getSource: function () {
  ...
  "function" == typeof define && define.amd
    ? define("plupload", ["./moxie"], t)
    : "object" == typeof module && module.exports
      ? (module.exports = t(require("./moxie")))
      : (e.plupload = t(e.moxie));
})(this || window);
