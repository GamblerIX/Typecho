!(function (e, t) {
  ...
  var d = (function (n) {
        ...
        if (p.qsa && (!v || !v.test(e))) {
          if (
            ...
            for (
              ...
              s[o] = u + pe(s[o]);
            ((l = (ee.test(e) && ce(t.parentNode)) || t), (c = s.join(",")));
          }
          if (c)
            try {
      ...
      function (e) {
        ...
        return u !== T && 9 === u.nodeType && u.documentElement
          ? ((r = (T = u).documentElement),
            ...
            (i = []),
            (v = []),
            (p.qsa = K.test(u.querySelectorAll)) &&
              (se(function (e) {
                ((e.innerHTML =
            ...
            (p.matchesSelector = K.test(
              ...
              se(function (e) {
                ((p.disconnectedMatch = s.call(e, "div")),
                  s.call(e, "[s!='']:x"),
                  i.push("!=", I));
              }),
    ...
    (re.matchesSelector = function (e, t) {
      if (
        ...
        (t = t.replace(U, "='$1']")),
        p.matchesSelector && y && (!i || !i.test(t)) && (!v || !v.test(t)))
      )
        try {
          var n = s.call(e, t);
          if (
        ...
        oe(function (e, t, n, r) {
          ...
          if (e) {
            if (y || d) {
              ...
              for (o = p.length; o--; )
                (s = p[o]) &&
                  -1 < (i = y ? P.call(e, s) : a[o]) &&
                  (e[i] = !(t[i] = s));
            }
          } else
            ((p = ge(p === t ? p.splice(l, p.length) : p)),
    ...
    function ye(m, y) {
      function e(e, t, n, r, i) {
        ...
        if (((u += l), v && l !== u)) {
          ...
          (O.apply(r, f),
            i && !e && 0 < f.length && 1 < u + y.length && re.uniqueSort(r));
        }
        return (i && ((k = h), (w = p)), c);
      }
      var v = 0 < y.length,
        ...
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === c.length)) {
            if (
              ...
              if (!(t = (b.find.ID(s.matches[0].replace(ne, f), t) || [])[0]))
                return n;
          ...
          return (
            (l || h(e, c))(r, t, !y, n, (ee.test(e) && ce(t.parentNode)) || t),
            n
          );
        }),
  ...
  (w.fn.init = function (e, t) {
    ...
    if (n[1]) {
      if (
        ...
        w.merge(
          this,
          w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : v, !0),
        ),
  ...
  var D,
    ...
    L = {};
  function q() {
    (v.removeEventListener("DOMContentLoaded", q, !1),
    ...
    w.extend({
      ...
      ready: function (e) {
        (!0 === e ? --w.readyWait : w.isReady) ||
          ...
          (D.resolveWith(v, [w]),
          w.fn.triggerHandler &&
            (w(v).triggerHandler("ready"), w(v).off("ready")));
      },
    }),
      ...
      return (
        D ||
          ...
          "complete" === v.readyState
            ? setTimeout(w.ready)
            : (v.addEventListener("DOMContentLoaded", q, !1),
  ...
  var n = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    I = /^(?:checkbox|radio)$/i;
  ((s = v.createDocumentFragment().appendChild(v.createElement("div"))),
    (d = v.createElement("input")).setAttribute("type", "radio"),
    ...
    mouseHooks: {
      ...
      filter: function (e, t) {
        ...
        return (
          null == e.pageX &&
            null != t.clientX &&
            ((n = (r = e.target.ownerDocument || v).documentElement),
            (r = r.body),
            (e.pageX =
              t.clientX +
  ...
  ((oe.optgroup = oe.option),
    ...
    w.extend({
      clone: function (e, t, n) {
        ...
        return (
          0 < (s = fe(c, "script")).length && le(s, !f && fe(e, "script")),
          c
        );
      },
    ...
    w.fn.extend({
      ...
      domManip: function (n, r) {
        ...
        var e,
          ...
          p = n[0],
          d = w.isFunction(p);
        if (d || (1 < l && "string" == typeof p && !y.checkClone && te.test(p)))
  ...
  function Ee() {
    ...
    ((ye = "1%" !== e.top), (ve = "4px" === e.width), xe.removeChild(be));
  }
  ((xe = v.documentElement),
    (be = v.createElement("div")),
      ...
      h.getComputedStyle &&
        w.extend(y, {
          ...
          reliableMarginRight: function () {
            var e = we.appendChild(v.createElement("div"));
            return (
              (e.style.cssText = we.style.cssText =
  ...
  (w.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        ("string" === (o = typeof n) &&
          (i = De.exec(n)) &&
          ((n = (i[1] + 1) * i[2] + parseFloat(w.css(e, t))), (o = "number")),
          null != n &&
            n == n &&
    ...
    w.each(["height", "width"], function (e, i) {
      w.cssHooks[i] = {
        get: function (e, t, n) {
          if (t)
            return Se.test(w.css(e, "display")) && 0 === e.offsetWidth
    ...
    (w.cssHooks.marginRight = ke(y.reliableMarginRight, function (e, t) {
      if (t)
        return w.swap(e, { display: "inline-block" }, Ne, [e, "marginRight"]);
    })),
    ...
    ze = [
      function (t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          "inline" ===
            ("none" === (l = w.css(t, "display")) ? ge(t.nodeName) : l) &&
            "none" === w.css(t, "float") &&
  ...
  ((w.Animation = w.extend(Ge, {
    ...
    (n = s.appendChild(v.createElement("option"))),
    (d.type = "checkbox"),
    (y.checkOn = "" !== d.value),
    (y.optSelected = n.selected),
    (s.disabled = !0),
    (y.optDisabled = !n.disabled),
    ((d = v.createElement("input")).value = "t"),
    (d.type = "radio"),
  ...
  ((w.offset = {
    ...
    w.each(["top", "left"], function (e, n) {
      w.cssHooks[n] = ke(y.pixelPosition, function (e, t) {
        if (t)
          return ((t = Ne(e, n)), Ce.test(t) ? w(e).position()[n] + "px" : t);
      });
    }),
